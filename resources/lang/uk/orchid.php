...
return [
    ...
    'pages'       => [
        ...
        'package_add'            => [
            'index'  => 'Додаткові курси',
            'create' => 'Створення додаткового курсу',
            'update' => 'Редагування додаткового курсу',
            'show'   => 'Додатковіі Курс',
            'delete' => 'Видалення додаткового курсу'
        ],
        'package'                => [
            'index'  => 'Пакети',
            'create' => 'Створення пакету',
            'update' => 'Редагування пакету',
            'show'   => 'Пакет',
            'delete' => 'Видалення пакету'
        ],
        'payment'                => [
            'index'  => 'Оплати',
